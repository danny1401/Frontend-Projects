...
$togrutenr3 = fopen('./togrutenr3.txt', 'r'); 
$togrutenr3 = fread($togrutenr3,filesize('./togrutenr3.txt'));
fclose($togrutenr3);

$tognr3 = fopen('./tognr3.txt', 'r'); 
$tognr3 = fread($tognr3,filesize('./tognr3.txt'));
fclose($tognr3);

$dato3 = fopen('./dato3.txt', 'r'); 
$dato3 = fread($dato3,filesize('./dato3.txt'));
fclose($dato3);

$tidspunkt3 = fopen('./tidspunkt3.txt', 'r'); 
$tidspunkt3 = fread($tidspunkt3,filesize('./tidspunkt3.txt'));
fclose($tidspunkt3);

$passasjer3 = fopen('./passasjerfil3.txt', 'r'); 
$passasjer3 = fread($passasjer3,filesize('./passasjerfil3.txt'));
fclose($passasjer3);

$seter3 = fopen('./seterfil3.txt', 'r'); 
$seter3 = fread($seter3,filesize('./seterfil3.txt'));
fclose($seter3);

$togtype3 = fopen('./togtype3.txt', 'r'); 
$togtype3 = fread($togtype3,filesize('./togtype3.txt'));
fclose($togtype3);
...
$gjennomsnitt = (($passasjer + $passasjer2 + $passasjer3) / ($seter + $seter2 + $seter3))*100;
$total1 = ($passasjer + $passasjer2 + $passasjer3); 
$total2 = ($seter + $seter2 + $seter3);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
<a href="./register3.php"><button id="knapp">Tilbake</button></a>
</center>
...
<div id="boks3">
	...
	<h3 id="color1">Antall passasjerer:</h3>
	<h3 id="color2">Antall seter:</h3>
	<img id="sektordiagram" src="./sektor3.php"></img>
</div>
	
<div id="boks4">
	<h1>Toginfo 4</h1>
	<a href="./../4/NSB_2_index4.php"><button id="knapp1">Opprett nytt tog</button></a>
</div>
...
<div id="boks9">
	...
	<h3 id="color1">Antall passasjerer:</h3>
	<h3 id="color2">Antall seter:</h3>
	<img id="sektordiagram" src="./gjennomsnitt3.php"></img>
</div>
