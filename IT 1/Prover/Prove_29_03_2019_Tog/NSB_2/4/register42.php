<?php
$passasjer = fopen('./passasjerfil4.txt', 'r'); 
$passasjer = fread($passasjer,filesize('./passasjerfil4.txt'));
fclose($passasjer);

$seter = fopen('./seterfil4.txt', 'r'); 
$seter = fread($seter,filesize('./seterfil4.txt'));
fclose($seter);
