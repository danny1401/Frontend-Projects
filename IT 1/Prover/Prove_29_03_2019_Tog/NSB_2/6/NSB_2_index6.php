...
$eksempel = fopen("./togrutenr6.txt", "w");
$tekst = $togrutenr;
$tekst .= "\r\n";
fwrite($eksempel, $tekst);
fclose($eksempel);

$eksempel1 = fopen("./tognr6.txt", "w");
$tekst1 = $tognr;
$tekst1 .= "\r\n";
fwrite($eksempel1, $tekst1);
fclose($eksempel1);

$eksempel2 = fopen("./dato6.txt", "w");
$tekst2 = $dato;
$tekst2 .= "\r\n";
fwrite($eksempel2, $tekst2);
fclose($eksempel2);

$eksempel3 = fopen("./tidspunkt6.txt", "w");
$tekst3 = $tidspunkt;
$tekst3 .= "\r\n";
fwrite($eksempel3, $tekst3);
fclose($eksempel3);

$eksempel4 = fopen("./passasjerfil6.txt", "w");
$tekst4 = $passasjerer;
$tekst4 .= "\r\n";
fwrite($eksempel4, $tekst4);
fclose($eksempel4);

$eksempel5 = fopen("./seterfil6.txt", "w");
$tekst5 = $seter;
$tekst5 .= "\r\n";
fwrite($eksempel5, $tekst5);
fclose($eksempel5);

$eksempel6 = fopen("./togtype6.txt", "w");
$tekst6 = $togtype;
$tekst6 .= "\r\n";
