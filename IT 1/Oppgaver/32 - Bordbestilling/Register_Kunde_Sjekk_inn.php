...
<div class="fixed" id="bar">
	<div class="buttons">
		...
		<a href="./Admin/Admin.php" class="meny"><strong>Admin</strong></a>
	</div>
...
<a href="./Kunde_opprett.php"><button id="knapp">Bestill på nytt</button></a>
...
<div id="boks">
	...
	<a href="./Kunde_opprett.php"><button id="knapp">Registrer en annen kunde</button>
	';
}
print '
</center>
