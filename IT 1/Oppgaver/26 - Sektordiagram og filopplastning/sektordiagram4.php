...
//Lager 3D effekt
    for ($i = 60; $i > 50; $i--) {
        imagefilledarc($eksempel, 50, $i, 100, 50, 130, 90, $darkred,  IMG_ARC_PIE);
        imagefilledarc($eksempel, 50, $i, 100, 50, 90, 120, $darkyellow, IMG_ARC_PIE);
        imagefilledarc($eksempel, 50, $i, 100, 50, 120, 130, $darkgreen, IMG_ARC_PIE);
    }

imagefilledarc($eksempel, 50, 50, 100, 50, 130, 90, $red, IMG_ARC_PIE);
imagefilledarc($eksempel, 50, 50, 100, 50, 90, 120, $yellow, IMG_ARC_PIE);
imagefilledarc($eksempel, 50, 50, 100, 50, 120, 130, $green, IMG_ARC_PIE);
