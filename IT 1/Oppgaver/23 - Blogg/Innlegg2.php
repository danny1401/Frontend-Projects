...
$eksempel_innlegg = fopen("./innleggtekst.txt", "a") or die("Kan ikke opne filen!");
$tekst = "<p>\n";
$tekst .= "$innlegg\n";
$tekst .= "\r\n";
fwrite($eksempel_innlegg, $tekst);
fclose($eksempel_innlegg);
...
<center><h1 id='title'>Innlegg i bloggen</h1></center>

<div id='boks3'>
<center><h3 id='title1'>Takk for ditt innlegg</h3></center>
Dette skrev du i din innlegg:<br><i>".$innlegg."</i>
</div>
